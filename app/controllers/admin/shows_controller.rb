class Admin::ShowsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @admin_show.update(admin_show_params)
        ...
        format.json { render :show, status: :ok, location: admin_show_path(@admin_show) }
      else
  ...
  private
    ...
    def admin_show_params
      params.require(:show).permit(:venue_name, :venue_address, :venue_address_url, :venue_url, :date)
    end
end
